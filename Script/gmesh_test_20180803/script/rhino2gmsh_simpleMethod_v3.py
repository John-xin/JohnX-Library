            ...
            for surface in surfaces:
                ...
                for line in lines:
                    ...
                    for pt in pts: #ignore the last point as it is same as the first point
                        ...
                        entry=(countPt,countPt,tmpX,tmpY,tmpZ,'False',countLine,countSurface,countVolume,layer)
...
def setPhysical(f):
    ...
    for layer in layerList: #each layer is defined as a physical surface
        ...
        for obj in objs:
            ...
            surfaceIndex=findSurfIndexByPts(points)
    ...
    for x in volumeMarkList:
        f.write("Physical Volume(\"domain\")={%d};\n" %x)
    conn.commit()
    c.close()
    conn.close()
    return
    ...
    for layer in layerList: #each sub layer
        ...
        if transfiniteType=="Line":
            ...
            for obj in objs:
                ...
                lineIndex=findLineIndexByPts(points)
