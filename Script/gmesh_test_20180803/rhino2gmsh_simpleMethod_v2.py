...
def rhino2gmsh():
    ...
    layerList.append("box2")
    meshSizeDict=[]
    meshSizeDict.append({'layerName':layerList[0],'meshSize':3,'meshSizeName':"meshSize_"+layerList[0]})
    #meshSizeDict.append({'layerName':layerList[1],'meshSize':3,'meshSizeName':"meshSize_"+layerList[1]})
